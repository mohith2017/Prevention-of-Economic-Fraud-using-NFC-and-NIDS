...
public class PasswordSetUser2 extends HttpServlet
{
	...
	boolean flag1 = UserDAO.Checkuserimage(uid.trim(), imgname, desc, has_mac);
		...
		if(flag1)
		{
			...
			rd = request.getRequestDispatcher("checkpassword_set3.jsp");
			rd.forward(request,response);
			
		}
		else
		{
			rd = request.getRequestDispatcher("checkpassword_set2.jsp?no=1");
			rd.forward(request,response);
