...
String data=DAO.retrieveImageone(user);
...
<form action="<%=request.getContextPath()%>/PasswordImageSet2" method="get">

<div class="background" id="pointer_1" style="position:relative;top: 100px;left:400px;width: 150px;height: 150px; ">

<img alt="" id="img1" src="<%=request.getContextPath()%>/Res/SourceImage/<%=dd[2]%>" onclick="test('1','<%=user%>')" >
...
<br></br>
					...
					<input type="hidden" name="imgnme" value="<%=dd[2]%>">
