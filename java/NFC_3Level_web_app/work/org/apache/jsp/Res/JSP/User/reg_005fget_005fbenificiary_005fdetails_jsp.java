...
public final class reg_005fget_005fbenificiary_005fdetails_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	if(Utility.parse(request.getParameter("no"))==1)
	{
      ...
      out.write("\t\talert(\"URN Number Successfully Sent to your EmailId.  Now You Can Confirm Benificiary by providing the URN Number through Confirn/Reject Link.!!\");\r\n");
      out.write("\t\t</script>\t\t\t\r\n");
	...
	if(Utility.parse(request.getParameter("no"))==2)
	{
      ...
      out.write("\r\n");
      out.write("\t\t<script type=\"text/javascript\">\r\n");
      out.write("\t\talert(\"Opps,Unable to Send URN Number to EmailId !!!!!!!\");\r\n");
      out.write("\t\t</script>\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t\t\t\r\n");
