...
String data=DAO.retrieveImageone(userid);

System.out.println("data is>>>>>>>>>>>>>>>>>>>> :"+data);

String dd[]=data.split(",");

System.out.println("<<<<<<<<<<<<<<<<<image"+dd[1]);
...
<form action="<%=request.getContextPath()%>/PasswordImageSet1" method="get">

<div class="background" id="pointer_1" style="position:relative;top: 100px;left:400px;width: 150px;height: 150px; ">

<img alt="" id="img1" src="<%=request.getContextPath()%>/Res/SourceImage/<%=dd[1]%>" onclick="test('1','<%=userid%>')" >
...
<br></br>
					...
					<input type="hidden" name="imgnme" value="<%=dd[1]%>">
