...
public class Utitlity {
	...
	public static String constructJSONlogin(boolean status) 
	{
		JSONObject obj = new JSONObject();
		try {
	...
	public static String constructJSONloginsTRING(String status) 
	{
		JSONObject obj = new JSONObject();
		try {
	...
	public static String constructJSONlogins(boolean status,ArrayList<String> data) 
	{
		JSONObject obj = new JSONObject();
		try {
	...
	public static String setchangepassresp(String atttype) 
	{
		JSONObject obj = new JSONObject();
		try {
