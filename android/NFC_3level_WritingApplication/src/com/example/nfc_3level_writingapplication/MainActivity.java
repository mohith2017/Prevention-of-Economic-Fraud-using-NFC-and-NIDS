...
EditText txt2;
    ...
    public void invokeWS(RequestParams params,String data)
	{
		...
		// prgDialog.show();
         ...
         client.get(Global.URL+"admin/login",params ,new AsyncHttpResponseHandler()
         {
                 ...
                 try {
                	    ...
                	    /*   Toast.makeText(getApplicationContext(), "##"+response, 1500).show();*/
	                       ...
	                       if(obj.getBoolean("status")==true )
	                         ...
	                         {
	                        	 Toast.makeText(getApplicationContext(), "Please Enter Adminid and password Correctly", Toast.LENGTH_LONG).show();
