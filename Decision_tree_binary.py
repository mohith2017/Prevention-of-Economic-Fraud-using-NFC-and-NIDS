...
def load_train_data(train_ratio=1):
    data = pd.read_csv('D:/DESKTOP/MSRIT/Final Year/8th sem/Project/Implementation/datasets/UNSW_NB15_training-set.csv', header=None,
...
def load_test_data(train_ratio=0):
    data = pd.read_csv('D:/DESKTOP/MSRIT/Final Year/8th sem/Project/Implementation/datasets/UNSW_NB15_testing-set.csv', header=None,
                       names=['x%i' % (i) for i in range(37)] + ['y'])
