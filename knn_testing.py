...
df = pd.read_csv("D:/DESKTOP/MSRIT/Final Year/8th sem/Project/Latest ML-IDS/Dataset/UNSW_NB15_testing-set.csv")
...
#Avg Precision score is best for k=2
k=4
...
print_report('Testing', cls_knn, X_transform, y.label, cls_knn.predict(X_transform))
end_time = time.time()
